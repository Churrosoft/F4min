...
/*
  ...
  Prescaler => 1200 => 0.01Mhz === 0.1mS ?
  Period => iny_time

  TIM 4:
  ClockDivision => TIM_CLOCKDIVISION_DIV4
  Prescaler => 6000 => 0.002Mhz === 0.5mS ?
  Period => ECNT (Inc/defines.h:43)
*/
...
void MX_TIM10_Init(void)
{
  ...
  htim10.Init.ClockDivision = TIM_CLOCKDIVISION_DIV1; //TIM_CLOCKDIVISION_DIV4;
